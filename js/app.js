const USER_INFO = {
    get name() {
        ...
        return u ? (u.full_name || 'Guest') : 'Guest';
    },
    get email() {
        const u = typeof Auth !== 'undefined' && Auth.getUser();
        return u ? (u.email || '') : '';
    ...
    getProfilePhoto: function() {
        const u = typeof Auth !== 'undefined' && Auth.getUser();
        return (u && u.profile_photo_url) || localStorage.getItem('profilePhoto') || 'https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-5.jpg';
    }
};
